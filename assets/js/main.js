...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- 2. Atualizar Link Ativo na Sidebar ---
    function updateActiveLinks(currentUrl) {
        ...
        document.querySelectorAll('.nav-file a, .folder-name-link').forEach(link => {
            ...
            if (decodeURIComponent(linkPath) === decodeURIComponent(currentPath) || (href === '/' && currentPath.endsWith('index.html'))) {
    ...
    document.addEventListener('click', (e) => {
        ...
        // Removemos o 'pdf' daqui para que os arquivos .html gerados para os PDFs
        // sejam carregados via SPA.
